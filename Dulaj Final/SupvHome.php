    ...
    <body class="w3-theme-l5" onload="loadFunc()">
            ...
            <div class="w3-row">
                ...
                <div class="w3-col m7">
                        ...
                        <div class="w3-col m12">
                            <div class="w3-card-2 w3-round w3-white">
                                <div class="w3-container w3-padding">
                                    <h6 class="w3-opacity"> Superintendent Accepted Requests</h6>
                    ...
                    <div class="w3-container w3-padding w3-card-2 w3-white w3-round w3-margin">
                        <h6 class="w3-opacity">Ongoing tasks</h6>
                    ...
                    <div class="w3-container w3-padding w3-card-2 w3-white w3-round w3-margin">
                        <h6 class="w3-opacity">Completed tasks</h6>
        ...
        <script type ="text/javascript" language="javascript">
            ...
            function loadCompletedHistory(){
                ...
                var myData = {'action':"getCompletedHistory",'luid': idt};
                $.ajax({
                    url: "SupvAction.php",
                    type: "POST",
                    data: myData,
                    success: function(res) {
                        if(!$.trim(res)){
                            ...
                            if(reqt){
                                var rr='<tr class="w3-theme-d5"> <th>Request Name</th><th>Requested by</th><th>Requested date</th><th>Completed date</th></tr>';
                                $("#reqTable").html(rr);
                            }
                            $("#reqTable").append(res);
                            reqt=false;
            ...
            function loadSubmittedRequests(){
                ...
                var myData = {'action':"getSTCheckedList",'lrid':llrid};
                $.ajax({
                    url: "SupvAction.php",
                    type: "POST",
                    data: myData,
            ...
            function sendRecom(rid,lbr){
                ...
                var myData = {'action':"logRecommendation",'lrid': rid,'luid':idt,'lbrid':lbrid,'date':dte};
                $.ajax({
                    url: "SupvAction.php",
                    type: "POST",
                    data: myData,
             ...
             function sendComp(rid){
                
                var d=new Date();
                var m=d.getMonth()+1;

                var dte=d.getFullYear().toString()+"-"+m.toString()+"-"+d.getDate().toString();
                
                var myData = {'action':"logCompletion",'lrid': rid,'date':dte};
                $.ajax({
                    url: "SupvAction.php",
                    type: "POST",
                    data: myData,
            ...
            function drop(ev,n) {
                ...
                var x=data.split("_");
                var dd= document.getElementById(x[0]+x[1]);
                ev.target.appendChild(document.getElementById(data));
                rd[n]=dd.innerHTML;
                document.getElementById("dbt"+n).disabled=false;
                
                //alert(rd[n]);
            }
            
            function sendBack(item,name){
                item.parentElement.style.display='none';
                var x=document.getElementById("cont");
                x.appendChild(document.getElementById(name));
