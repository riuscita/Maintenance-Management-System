    ...
    <body class="w3-theme-l5" onload="loadFunc()">
            ...
            <div class="w3-row">
                ...
                <div class="w3-col m7">
                    ...
                    <div class="w3-container w3-padding w3-card-2 w3-white w3-round w3-margin">
                        <h6 class="w3-opacity">Accepted Requests</h6>
                ...
                <div class="w3-container">
                    ...
                    <form>
                        <p><select class="w3-select w3-padding-16 w3-border" id="type" required name="type">
                            ...
                            <p><input class="w3-input w3-padding-16 w3-border" id="desc" required name="desc" oninput="validateReq(this.val)"></p>
                        <p><button class="w3-button" type="button" id="updateBtn" onclick="addRequest()" disabled="true">Submit</button></p>

                        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
                        <script type ="text/javascript" language="javascript">
                            function validateReq(val){
                                //alert(val);
        ...
        <script type ="text/javascript" language="javascript">
            ...
            function loadSubmittedRequests(){
                ...
                var myData = {'action':"getRequestList",'lrid':llrid,'xuid':idt};
                $.ajax({
                    url: "HODAction.php",
                    type: "POST",
                    data: myData,
