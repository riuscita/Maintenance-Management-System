        ...
        <div id="signup" class="w3-modal">
            <div class="w3-modal-content w3-animate-zoom">
                ...
                <div class="w3-container">
                    ...
                    <form>
                        <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Name" id="name" required name="name" oninput="validatePsw()"></p>
                        <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="University ID" oninput="validateIndex(this.value)" id="uid" required name="uid" onchange="validatePsw()"></p>
                        <p><select class="w3-select w3-padding-16 w3-border" id="dsg" required name="dsg" oninput="validatePsw()">
                        ...
                        <p><input class="w3-input w3-padding-16 w3-border" type="password" placeholder="Type a password" id="password" required name="psw" oninput="validatePsw()"></p>
                        <p><input class="w3-input w3-padding-16 w3-border" type="password" placeholder="Re type Password" id="repassword" required name="rpsw" oninput="validatePsw()"></p>
                        ...
                        <script type ="text/javascript" language="javascript">
                            ...
                            function validatePsw(){
                                ...
                                if((ps!="")&&(ps==rps)&& (uidt!="")&&(namet!="")&&(dsge!="")&& (depe!="")){
