            ...
            <div class="w3-row">
                        ...
                        <div class="w3-col m12">
                            <div class="w3-card-2 w3-round w3-white">
                                <div class="w3-container w3-padding">
                                    <h6 class="w3-opacity">Submitted Requests</h6>
                                    <table class="w3-table" id="recomTable">
                                        ...
                                        <tr >
                                            <td><div class="w3-text">Wire repair</div></td>
                                            <td><div class="w3-text">Senuri</div></td>
                                            <td><div class="w3-text">02/08/2014</div></td>
                                            <td><div id ="div1"  ondrop="drop(event)" ondragover="allowDrop(event)"></div></td>
                                        </tr>

                                        <tr >
                                            <td><div class="w3-text">Wall repair</div></td>
                                            <td><div class="w3-text">Mawli</div></td>
                                            <td><div class="w3-text">17/10/2014</div></td>
                                            <td><div id ="div1"  ondrop="drop(event)" ondragover="allowDrop(event)"></div></td>
                                        </tr>
                ...
                <div class="w3-col m2">
                    <div class="w3-card-2 w3-round w3-white w3-center">
                        <div class="w3-container">
                            <p>Try drag and drop from EXO </p>

                            <div class="w3-container  w3-display-container w3-theme-l4 w3-margin-bottom" style="height:40px;" id="ch" draggable="true" ondragstart="drag(event)">
                                <span class="w3-text w3-display-middle">Chanyeol</span>
                                <span class="w3-button w3-display-right">x</span>
                            </div>
                            
                            <div class="w3-container  w3-display-container w3-theme-l4 w3-margin-bottom" style="height:40px;" id="bk" draggable="true" ondragstart="drag(event)">
                                <span class="w3-text w3-display-middle">Baekhyun</span>
                                <span class="w3-button w3-display-right">x</span>
                            </div>
                            
                            <div class="w3-container  w3-display-container w3-theme-l4 w3-margin-bottom" style="height:40px;" id="sh" draggable="true" ondragstart="drag(event)">
                                <span class="w3-text w3-display-middle">Sehun</span>
                                <span class="w3-button w3-display-right">x</span>
                            </div>
